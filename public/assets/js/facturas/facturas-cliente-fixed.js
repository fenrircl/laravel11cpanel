// filepath: /var/www/test/public/assets/js/facturas/facturas-cliente.js
$(document).ready(function() {
    ...
    const tempFilters = sessionStorage.getItem(`temp-filters-facturas-clientes-table`);
        ...
        ajax: {
            ...
            dataSrc: function(json) {
                ...
                if (shouldFilterPending || shouldFilterByStatus) {
                    ...
                    console.log(`Filtro aplicado (clientes): ${data.length} facturas mostradas`);
                }
        ...
        buttons: [
            { extend: 'copy', text: 'Copiar', className: 'btn btn-secondary btn-sm' },
            {
                ...
                filename: function() {
                    ...
                    return 'facturas_clientes_' + dateStr;
                },
                exportOptions: {
                    ...
                    format: {
                        body: function(data, row, column, node) {
                            ...
                            // Obtener los datos de la fila completa
                            const table = $('#facturas-clientes-table').DataTable();
                            const rowData = table.row(row).data();
                            
                            // Llamar al render con type 'export'
                            const exportValue = columnDef.render(data, 'export', rowData);
                            
                            // Si el render devuelve algo específico para export, usarlo
                            return exportValue !== undefined ? exportValue : data;
                        }
                    }
                }
            },
