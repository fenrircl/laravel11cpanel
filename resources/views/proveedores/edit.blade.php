                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('box') is-invalid @enderror" 
                                      ...
                                      name="box" 
                                      rows="3"
                                      placeholder="Información adicional: persona de contacto, datos bancarios, etc.">{{ old('box', $proveedor->box) }}</textarea>
                            @error('box')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="d-flex justify-content-between">
                    <div>
                        <small class="text-muted">
                            ...
                            Creado: {{ $proveedor->created_at ? $proveedor->created_at->format('d/m/Y H:i') : '—' }}
