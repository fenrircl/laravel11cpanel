...
@push('styles')
    ...
    <link href="{{ asset('assets/css/clientes/clientes.css') }}?v={{ assets_version() }}" rel="stylesheet">
@endpush
...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="{{ route('clientes.show', $cliente) }}" class="btn btn-secondary btn-sm">Volver</a>
        </div>
    </div>
        ...
        <div class="card-body">
            <form action="{{ route('clientes.update', $cliente) }}" method="POST">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('clientes.show', $cliente) }}" class="btn btn-secondary me-2">Cancelar</a>
